...
public class ResultTest {
    ...
    public void aRejectedResultShouldHaveATypeOfUnprocessableEntityByDefault() {
        Result<String> result = Result.reject("instance").with(Reportable.message("some message"));
    ...
    public void shouldBeAbleToProduceAResultWithAResultTypeOfConflict() {
        Result<String> result = Result.conflict("instance").with(Reportable.message("some message"));
        assertThat(result.getType()).isEqualTo(ResultType.CONFLICT);
    }

    @Test
    public void shouldBeAbleToProduceAResultWithAResultTypeOfNotFound() {
        Result<String> result = Result.not_found("instance").with(Reportable.message("Resource not found."));
    ...
    public void shouldBeAbleToProduceAResultWithAResultTypeOfNotAuthenticated() {
        Result<String> result = Result.not_authenticated("instance").with(Reportable.message("some message"));
    ...
    public void shouldBeAbleToProduceAResultWithAResultTypeOfBadRequest() {
        Result<String> result = Result.bad_request("instance").with(Reportable.message("some message"));
    ...
    public void shouldBeAbleToProduceAResultWithAResultTypeOfInternalError() {
        Result<String> result = Result.internal_error("instance").with(Reportable.message("some message"));
    ...
    public void shouldBeAbleToRaiseAnUnprocessableEntityException() {
        Result<String> result = Result.reject("instance").with(Reportable.message("An error message"));
    ...
    public void shouldBeAbleToRaiseAResourceConflictException() {
        Result<String> result = Result.conflict("instance").with(Reportable.message("An error message"));
    ...
    public void shouldBeAbleToRaiseABadRequestException() {
        Result<String> result = Result.bad_request("instance").with(Reportable.message("An error message"));
    ...
    public void shouldBeAbleToRaiseAnAuthenticationException() {
        Result<String> result = Result.not_authenticated("instance").with(Reportable.message("An error message"));
    ...
    public void shouldBeAbleToRaiseAnAuthorizationException() {
        Result<String> result = Result.unauthorized("instance").with(Reportable.message("An error message"));
    ...
    public void shouldBeAbleToRaiseAnEntityNotFoundException() {
        Result<String> result = Result.not_found("instance").with(Reportable.message("An error message"));
    ...
    public void shouldBeAbleToRaiseAnInternalErrorException() {
        Result<String> result = Result.internal_error("instance").with(Reportable.message("An error message"));
